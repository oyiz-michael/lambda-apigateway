...
#   parent_id   = each.value.parent_id != "" ? each.value.parent_id : aws_api_gateway_rest_api.api_gateway.root_resource_id
...
#   uri                  = each.value.lambda_arn != "" ? "arn:aws:apigateway:${var.region}:lambda:path/2015-03-31/functions/${each.value.lambda_arn}/invocations" : null
# }
